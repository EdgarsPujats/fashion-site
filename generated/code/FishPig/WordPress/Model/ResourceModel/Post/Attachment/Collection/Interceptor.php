...
/**
 * Interceptor class for @see \FishPig\WordPress\Model\ResourceModel\Post\Attachment\Collection
 */
class Interceptor extends \FishPig\WordPress\Model\ResourceModel\Post\Attachment\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setParent');
        return $pluginInfo ? $this->___callPlugins('setParent', func_get_args(), $pluginInfo) : parent::setParent($parentId);
    }
